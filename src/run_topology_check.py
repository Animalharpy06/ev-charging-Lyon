...
def run_topology_check() -> None:
    ...
    hta_lines_district, endpoint_nodes, junction_nodes, orphans = build_endpoint_snapping(hta_lines_district, substations_district, district_boundary)

    hta_lines_district = classify_lines(hta_lines_district, endpoint_nodes, district_boundary)
